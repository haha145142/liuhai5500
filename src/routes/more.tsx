...
import { Activity, BarChart3, BriefcaseBusiness, GitCompare, Settings2, Sparkles, Trophy, Wrench, Users } from "lucide-react";
import { Glass } from "@/components/ui/Glass";
export const Route=createFileRoute("/more")({component:MorePage});
const LINKS=[
 ["/portfolio","我的持仓","资产、盈亏、组合体检",BriefcaseBusiness],["/groups","投资组合","稳健 / 定投 / 观察清单",Users],["/compare","基金对比","最多5只 · 回撤 · 夏普 · 波动",GitCompare],["/tools","决策工具","申赎 · 定投 · 压测 · 目标收益",Wrench],["/market","行情中心","指数 · 板块 · 资金 · 外围",BarChart3],["/rotation","AI轮动雷达","板块强度 · 资金 · 基金池",Activity],["/ai","AI证据链","七步证据 · DeepSeek复核",Sparkles],["/funds","基金排行","日涨幅 · 阶段收益",Trophy],["/settings","设置","数据源 · 刷新 · Key",Settings2]
] as const;
