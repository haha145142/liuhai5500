...
function MarketPage() {
  ...
  return <div className="market-page">
    <FundSectorWatchV2 />
    <FoldSection title="操作建议" subtitle="根据自选板块、大盘与可验证资金数据生成" open={open.advice} onToggle={() => toggle("advice")}><OperationAdvice sectors={snapshot?.sectors || []} benchPct={benchPct} /></FoldSection>
    ...
    <FoldSection title="资金雷达" subtitle="今天钱往哪儿跑 · 谁在买卖" open={open.money} onToggle={() => toggle("money")}><MarketPanorama /></FoldSection>
