...
test("calendar-based week uses the latest available trading day on or before the boundary", () => {
  const result = calcPortfolioPeriodReturn(
    [{ code: "000001", name: "A", shares: 10, cost: 1 }],
    {
      "000001": {
        code: "000001", name: "A", type: "基金", nav: 1.3, navDate: "2026-08-28", estimate: 1.3,
        ...
        metrics: null, source: "test", officialNavPublished: false, valuationStatus: "estimate", estimateConfidence: "high",
