...
import { o as clockStr, s as cnTime, t as DEFAULT_SECTOR_IDS } from "./format-B7cjnRuX.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/router-Byr1StPg.js
...
var analyzeNews = createServerFn({ method: "POST" }).validator((input) => input).handler(createSsrRpc("57c407fae0cd5ef4799fc602a31b13230fa9461e3c1969ac48deedbf69111048"));
	...
	refreshFunds: async () => {
		...
		try {
			...
			const entries = await Promise.all(codes.map(async (code) => {
				try {
					return [code, await getFund({ data: { code } })];
				} catch {
					return null;
				}
			}));
...
function BottomNav() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("nav", {
		...
		children: [
			...
			"资讯",
			"我的"
		].map((item, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
			className: i === 0 ? "active" : "",
			children: item
		}, item))
	});
}
var styles_default = "/assets/styles-CEIP2EFX.css";
...
//#endregion
export { analyzeMarket as a, searchFund as c, getDSModel as d, setDSKey as f, useApp as i, createSsrRpc as l, cn as m, isTradeTime as n, analyzeNews as o, setDSModel as p, isWeekend as r, getFundRank as s, router_exports as t, getDSKey as u };
